...
export const faqs = [
  {
    ...
    text: `<h3  > What is Blacktinum, and how can I make money from trading it? </h3>
            <p> Blacktinum is a digital form of money that operates on decentralized networks and uses cryptography for security. You can profit by buying cryptocurrencies when prices are low and selling them when their value rises. </p>
            <h3>What are the risks involved in trading Blacktinum?</h3>
            <p>Blacktinum trading can be risky due to its high volatility. However, unlike traditional forex, crypto’s “floating losses” only become real if you sell at a lower price than what you paid. The key is smart trading and informed decisions.</p>
            ...
            <h3>What experience does Blacktinum have in Blacktinum trading?</h3>
            ...
            <p>As long as Blacktinum trading and referral programs exist, Blacktinum will continue to thrive and evolve.</p>
`,
    open: true,
  },
  {
  ...
  },
  {
    ...
    text: `
        ...
        <ol>
         ...
         <li>Watch your profits grow automatically! <br/>
             Blacktinum’s AI works 24/7, spotting profitable opportunities and executing precise trades, all while you sit back and relax—no trading knowledge required. </li>
        </ol>
