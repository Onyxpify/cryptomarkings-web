  ...
  return (
    <div>
      <div className="flex flex-row flex-wrap items-center justify-between gap-10 mt-9 ">
        <div className="flex flex-row items-start justify-center gap-1 p-1 bg-mgreen1 w-fit rounded-2xl ">
          <span className="text-[18] font-lato font-normal text-active ">
            Active Trades{" "}
          </span>
          <span className="text-[18] font-lato font-bold text-active">
            Total 2
          </span>
        </div>
        <div>
      ...
      {/* table */}
      {useMarketTable2({ data: openTradesData, render: "openned" })}
