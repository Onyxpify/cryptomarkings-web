  ...
  return (
    <div id="Dash_Line4">
      <div className="boxa">
        <div className="cell1">
          <h3>
            Top Traders <span> {svgs.alert_circle} </span>{" "}
          </h3>
          <div className="">
            <LearnMore />
          </div>
              ...
              <div key={each.id} className="list">
                <div className="unit1">
                  ...
                  <div className="texts">
                    <h5> {each.name} </h5>
                    <p>
                      <span> {svgs.networkBar} </span> {each.text}{" "}
                      <span className="rate"> {each.rate} </span>
                    </p>
                  </div>
                </div>
                <div className="unit2">
                  <Link style={{ backgroundColor: each.bg }} to={"#"}>
                    {" "}
                    {each.status}{" "}
                  </Link>
                </div>
      ...
      <div className="boxb">
        <div className="cell1">
          <h3>
            Top Robots <span> {svgs.alert_circle} </span>{" "}
          </h3>
          <div className="">
            <LearnMore />
          </div>
